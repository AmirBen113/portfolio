export const locale = {
    ...
    data: {
        'about': {
            ...
            'introductionOfMe': "Ingénieur expérimenté en développement Java & Angular. J'ai travaillé avec succès dans plusieurs entreprises où j'ai contribué à la conception et développement  d'applications métiers ainsi que le déploiment continue. ",
            ...
            'researchDescription': "J'aime travailler avec des systèmes complexes et des environnements à fort trafic, avec un état d'esprit agile et dynamique. Toujours à la recherche du challenge technique et de l'innovation.",
            'and':'et',
